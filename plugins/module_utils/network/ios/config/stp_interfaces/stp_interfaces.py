...
"""
The ios_stp_interfaces config file.
...
class STP_interfaces(ResourceModule):
    """
    The ios_stp_interfaces config class
    """

    def __init__(self, module):
        super(STP_interfaces, self).__init__(
            empty_fact_val={},
            facts_module=Facts(module),
            module=module,
            resource="stp_interfaces",
            tmplt=STP_interfacesTemplate(),
        )
        self.parsers = [
            "bpduguard",
        ]
